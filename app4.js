...
const startSpotifyOAuth = (pendingUrl) => {
  ...
  // Show fallback button in case auto-redirect is blocked
  document.body.innerHTML = '<div style="position:fixed;inset:0;background:#090909;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;padding:24px"><div style="color:#1DB954;font-family:sans-serif;font-size:22px;font-weight:700">Connecting to Spotify...</div><div style="color:#555;font-size:13px;text-align:center">If the login page does not open automatically, tap below</div><a href="' + authUrl + '" style="background:#1DB954;color:#000;padding:14px 32px;border-radius:8px;font-weight:700;text-decoration:none;font-size:16px;margin-top:8px">Open Spotify Login</a></div>';
