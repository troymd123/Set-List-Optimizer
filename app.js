...
// ── Spotify import ────────────────────────────────────────────────────────────
const importFromSpotify = async (overrideUrl='') => {
  ...
  try {
    ...
    // returns null when redirecting to Spotify login — that is OK
    if (!result) { setState({loadingSpotify:false}); return; }
      ...
      h('div',{className:'settings-section'},
        ...
        connected
          ...
          : h('div',{},
              ...
              h('p',{className:'field-hint',style:{marginTop:'6px'}},'Clicking Connect will open Spotify to authorise — you'll be sent back here automatically.')
            )
      ),
