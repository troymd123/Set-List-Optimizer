  ...
  if (isEditing) {
    return h('div',{className:'song-card',style:{borderLeft:`3px solid ${gc}`,flexWrap:'wrap'}},
      h('div',{className:'edit-row'},
        h('input',{className:'inp',placeholder:'Title',defaultValue:state.editData.title||'',
          onBlur:e=>setState({editData:{...state.editData,title:e.target.value}})}),
        h('input',{className:'inp inp-md',placeholder:'Artist',defaultValue:state.editData.artist||'',
          onBlur:e=>setState({editData:{...state.editData,artist:e.target.value}})}),
        ...
        h('input',{className:'inp inp-sm',placeholder:'BPM',type:'number',defaultValue:state.editData.bpm||'',
          onBlur:e=>setState({editData:{...state.editData,bpm:e.target.value}})}),
        ...
        h('input',{className:'inp inp-sm',placeholder:'m:ss',defaultValue:state.editData.duration||'',
          onBlur:e=>setState({editData:{...state.editData,duration:e.target.value}})}),
        ...
        h('input',{className:'inp inp-sm',placeholder:'Capo',type:'number',min:'0',max:'12',
          defaultValue:state.editData.capo||0,
          onBlur:e=>setState({editData:{...state.editData,capo:parseInt(e.target.value)||0}})}),
  ...
  return h('div',{},
    h('div',{className:'generate-panel'},
      ...
      h('div',{className:'generate-controls',style:{flexWrap:'wrap',gap:'8px'}},
        ...
        h('input',{className:'inp',type:'number',min:'1',max:'5',style:{maxWidth:'55px'},
          defaultValue:numberOfSets,
          onBlur:e=>setState({numberOfSets:parseInt(e.target.value)||1}),
          onKeydown:e=>e.key==='Enter'&&setState({numberOfSets:parseInt(e.target.value)||1})}),
        h('span',{style:{fontSize:'12px',color:'#555'}},'×'),
        h('input',{className:'inp',type:'number',min:'15',max:'180',style:{maxWidth:'70px'},
          defaultValue:targetMinutes,
          onBlur:e=>setState({targetMinutes:parseInt(e.target.value)||60}),
          onKeydown:e=>e.key==='Enter'&&setState({targetMinutes:parseInt(e.target.value)||60})}),
        h('span',{style:{fontSize:'12px',color:'#555'}},'min each'),
        numberOfSets>1&&h('span',{style:{fontSize:'12px',color:'#888'}},'Break:'),
        numberOfSets>1&&h('input',{className:'inp',type:'number',min:'5',max:'60',style:{maxWidth:'55px'},
          defaultValue:breakMinutes,
          onBlur:e=>setState({breakMinutes:parseInt(e.target.value)||15}),
          onKeydown:e=>e.key==='Enter'&&setState({breakMinutes:parseInt(e.target.value)||15})}),
