    ...
    try {
      ...
      setTimeout(() => {
        try {
          ...
          rootEl.innerHTML = '<div style="color:#e85d3a;padding:20px;font-family:monospace;font-size:11px;white-space:pre-wrap;background:#090909">RENDER ERROR:\n' + e.message + '\n' + (e.stack||'').slice(0,600) + '</div>';
        }
      }, 100);
    } catch(renderErr) {
